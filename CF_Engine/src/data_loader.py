...
class DataLoader(CFBase):
    """watch_history DB 조회 → 희소 행렬 변환."""

    def load_matrix(self, conn, alpha: float = 40, filter_quality: bool = False):
...
get_conn = CFBase.get_conn
load_matrix = data_loader.load_matrix
