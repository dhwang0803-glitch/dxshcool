...
> 이 문서는 Milvus + PostgreSQL 이중 구조를 전제로 작성된 **초기 설계 초안**입니다.
> **2026-03-08 아키텍처 결정**: 벡터 저장소를 **pgvector 단일화**로 변경. Milvus 미사용.
> 현행 설계 기준 문서: `plans/PLAN_04_EXTENSION_TABLES.md`, `schemas/create_embedding_tables.sql`
> 이 파일은 의사결정 히스토리 보존 목적으로만 유지됩니다. 새 개발 시 참조 금지.
...
**버전**: 1.0
**작성일**: 2026-03-05
**대상 시스템**: 하이브리드 검색 기반 추천 시스템 (Milvus + PostgreSQL 멀티 티어 캐싱) — DEPRECATED
